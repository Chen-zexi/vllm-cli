...
class ModelDirectoriesUI:
    ...
    def _display_directories(self):
        ...
        try:
            ...
            for idx, dir_info in enumerate(directories, 1):
                ...
                path_obj = Path(path)
                status = "[green]✓ Valid[/green]" if path_obj.exists() else "[red]✗ Missing[/red]"
    ...
    def _show_statistics(self):
        ...
        try:
            ...
            dir_text.append(f"Last scan: Recent")
            ...
            if 'by_directory' in stats:
                ...
                for dir_path, dir_stats in stats['by_directory'].items():
                    ...
                    console.print(f"    Size: {dir_stats.get('size', 0) / (1024**3):.2f} GB")
